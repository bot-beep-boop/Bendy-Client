...
public class HUDConfigScreen extends GuiScreen
{
    ...
    public HUDConfigScreen(final HUDManager api, final boolean clear) {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final float zBackup = HUDConfigScreen.zLevel;
        HUDConfigScreen.zLevel = 200.0f;
        ...
        HUDConfigScreen.zLevel = zBackup;
    }
    
    public void drawHollowRect(final int x, final int y, final int w, final int h, final int color) {
