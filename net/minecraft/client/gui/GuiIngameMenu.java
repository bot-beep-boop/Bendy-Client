...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui() {
        ...
        if (this.mc.isSingleplayer()) {
            ...
            this.buttonList.add(new GuiButton(77, this.width / 2 + 2, this.height / 4 + 96 + i, 98, 20, I18n.format("Server List", new Object[0])));
        }
        this.buttonList.add(new GuiButton(187, this.width / 2 - 100, this.height / 4 + 120 + i, I18n.format(String.valueOf(Client.ClientName) + " Settings", new Object[0])));
