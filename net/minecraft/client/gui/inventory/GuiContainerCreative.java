...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    protected void handleMouseClick(final Slot slotIn, final int slotId, final int clickedButton, int clickType) {
        ...
        if (slotIn == null && GuiContainerCreative.selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && clickType != 5) {
            final InventoryPlayer inventoryplayer1 = this.mc.thePlayer.inventory;
            ...
            if (slotIn == this.field_147064_C) {
                ...
                this.mc.thePlayer.dropPlayerItemWithRandomChoice(itemstack6, true);
            ...
            final InventoryPlayer inventoryplayer2 = this.mc.thePlayer.inventory;
            ...
            if (clickType == 2) {
                if (itemstack8 != null && clickedButton >= 0 && clickedButton < 9) {
                    ...
                    this.mc.thePlayer.inventory.setInventorySlotContents(clickedButton, itemstack9);
                    this.mc.thePlayer.inventoryContainer.detectAndSendChanges();
                }
                return;
            }
            ...
            if (clickType == 4) {
                if (itemstack8 != null) {
                    ...
                    this.mc.thePlayer.dropPlayerItemWithRandomChoice(itemstack11, true);
    ...
    private void updateCreativeSearch() {
        ...
        while (iterator.hasNext()) {
            ...
            boolean flag = false;
            for (final String s2 : itemstack.getTooltip(this.mc.thePlayer, this.mc.gameSettings.advancedItemTooltips)) {
    ...
    protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mouseX, final int mouseY) {
        ...
        Gui.drawTexturedModalRect(this.guiLeft, this.guiTop, 0, 0, this.xSize, this.ySize);
        ...
        if (creativetabs.shouldHidePlayerInventory()) {
            Gui.drawTexturedModalRect(i, j + (int)((k - j - 17) * this.currentScroll), 232 + (this.needsScrollBars() ? 0 : 12), 0, 12, 15);
        }
    ...
    protected void func_147051_a(final CreativeTabs p_147051_1_) {
        ...
        GlStateManager.disableLighting();
        Gui.drawTexturedModalRect(l, i2, j, k, 28, j2);
