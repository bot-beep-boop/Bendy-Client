...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(final float partialTicks) {
        ...
        GlStateManager.enableBlend();
        if (!ModPerspective.perspectiveToggled && this.showCrosshair()) {
        ...
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            if (entity == null) {
                ...
                for (int k6 = 0; k6 < 10; ++k6) {
                    ...
                    Gui.drawTexturedModalRect(i8, i7, 16 + j7 * 9, 27, 9, 9);
                    if (flag2) {
                        if (k6 * 2 + 1 < l) {
                            Gui.drawTexturedModalRect(i8, i7, l5 + 54, 27, 9, 9);
                        }
                        if (k6 * 2 + 1 == l) {
                            Gui.drawTexturedModalRect(i8, i7, l5 + 63, 27, 9, 9);
                        }
                    }
                    if (k6 * 2 + 1 < k) {
                        Gui.drawTexturedModalRect(i8, i7, l5 + 36, 27, 9, 9);
                    }
                    if (k6 * 2 + 1 == k) {
                        Gui.drawTexturedModalRect(i8, i7, l5 + 45, 27, 9, 9);
                    }
                }
            }
                ...
                while (k7 > 0) {
                    ...
                    for (int i9 = 0; i9 < l6; ++i9) {
                        ...
                        Gui.drawTexturedModalRect(l7, j9, j10 + k9 * 9, 9, 9, 9);
                        if (i9 * 2 + 1 + k8 < j8) {
                            Gui.drawTexturedModalRect(l7, j9, j10 + 36, 9, 9, 9);
                        }
                        if (i9 * 2 + 1 + k8 == j8) {
                            Gui.drawTexturedModalRect(l7, j9, j10 + 45, 9, 9, 9);
                        }
                    }
                    j9 -= 10;
                    k8 += 20;
