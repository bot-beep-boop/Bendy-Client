...
public class GuiScreenRealmsProxy extends GuiScreen
{
    ...
    public GuiScreenRealmsProxy(final RealmsScreen p_i1087_1_) {
        GuiScreenRealmsProxy.field_154330_a = p_i1087_1_;
        super.buttonList = Collections.synchronizedList((List<GuiButton>)Lists.newArrayList());
    }
    
    public RealmsScreen func_154321_a() {
        return GuiScreenRealmsProxy.field_154330_a;
    }
    
    @Override
    public void initGui() {
        GuiScreenRealmsProxy.field_154330_a.init();
        super.initGui();
    }
    ...
    public static void drawTexturedModalRect(final int x, final int y, final int textureX, final int textureY, final int width, final int height) {
        GuiScreenRealmsProxy.field_154330_a.blit(x, y, textureX, textureY, width, height);
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        GuiScreenRealmsProxy.field_154330_a.render(mouseX, mouseY, partialTicks);
    }
    ...
    public void updateScreen() {
        GuiScreenRealmsProxy.field_154330_a.tick();
        super.updateScreen();
    }
    ...
    public final void actionPerformed(final GuiButton button) throws IOException {
        GuiScreenRealmsProxy.field_154330_a.buttonClicked(((GuiButtonRealmsProxy)button).getRealmsButton());
    }
    ...
    public void mouseClicked(final int mouseX, final int mouseY, final int mouseButton) throws IOException {
        GuiScreenRealmsProxy.field_154330_a.mouseClicked(mouseX, mouseY, mouseButton);
        super.mouseClicked(mouseX, mouseY, mouseButton);
    }
    
    @Override
    public void handleMouseInput() throws IOException {
        GuiScreenRealmsProxy.field_154330_a.mouseEvent();
        super.handleMouseInput();
    }
    
    @Override
    public void handleKeyboardInput() throws IOException {
        GuiScreenRealmsProxy.field_154330_a.keyboardEvent();
        super.handleKeyboardInput();
    }
    
    public void mouseReleased(final int mouseX, final int mouseY, final int state) {
        GuiScreenRealmsProxy.field_154330_a.mouseReleased(mouseX, mouseY, state);
    }
    
    public void mouseClickMove(final int mouseX, final int mouseY, final int clickedMouseButton, final long timeSinceLastClick) {
        GuiScreenRealmsProxy.field_154330_a.mouseDragged(mouseX, mouseY, clickedMouseButton, timeSinceLastClick);
    }
    
    public void keyTyped(final char typedChar, final int keyCode) throws IOException {
        GuiScreenRealmsProxy.field_154330_a.keyPressed(typedChar, keyCode);
    }
    
    @Override
    public void confirmClicked(final boolean result, final int id) {
        GuiScreenRealmsProxy.field_154330_a.confirmResult(result, id);
    }
    
    @Override
    public void onGuiClosed() {
        GuiScreenRealmsProxy.field_154330_a.removed();
        super.onGuiClosed();
    }
}
