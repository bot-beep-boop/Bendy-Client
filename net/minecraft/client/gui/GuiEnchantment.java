...
public class GuiEnchantment extends GuiContainer
{
    ...
    protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mouseX, final int mouseY) {
        ...
        for (int l = 0; l < 3; ++l) {
            ...
            GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
            if (l2 == 0) {
                Gui.drawTexturedModalRect(i2, j + 14 + 19 * l, 0, 185, 108, 19);
            }
            else {
                ...
                if ((k < l + 1 || this.mc.thePlayer.experienceLevel < l2) && !this.mc.thePlayer.capabilities.isCreativeMode) {
                    Gui.drawTexturedModalRect(i2, j + 14 + 19 * l, 0, 185, 108, 19);
                    Gui.drawTexturedModalRect(i2 + 1, j + 15 + 19 * l, 16 * l, 239, 16, 16);
                    ...
                    if (j3 >= 0 && k3 >= 0 && j3 < 108 && k3 < 19) {
                        Gui.drawTexturedModalRect(i2, j + 14 + 19 * l, 0, 204, 108, 19);
                        i3 = 16777088;
                    }
                    else {
                        Gui.drawTexturedModalRect(i2, j + 14 + 19 * l, 0, 166, 108, 19);
                    }
                    Gui.drawTexturedModalRect(i2 + 1, j + 15 + 19 * l, 16 * l, 223, 16, 16);
