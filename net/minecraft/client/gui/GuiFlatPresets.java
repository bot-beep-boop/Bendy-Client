...
public class GuiFlatPresets extends GuiScreen
{
    ...
    class ListSlot extends GuiSlot
    {
        ...
        private void func_148171_c(final int p_148171_1_, final int p_148171_2_, final int p_148171_3_, final int p_148171_4_) {
            ...
            worldrenderer.pos(p_148171_1_ + 0, p_148171_2_ + 18, GuiFlatPresets.zLevel).tex((p_148171_3_ + 0) * 0.0078125f, (p_148171_4_ + 18) * 0.0078125f).endVertex();
            worldrenderer.pos(p_148171_1_ + 18, p_148171_2_ + 18, GuiFlatPresets.zLevel).tex((p_148171_3_ + 18) * 0.0078125f, (p_148171_4_ + 18) * 0.0078125f).endVertex();
            worldrenderer.pos(p_148171_1_ + 18, p_148171_2_ + 0, GuiFlatPresets.zLevel).tex((p_148171_3_ + 18) * 0.0078125f, (p_148171_4_ + 0) * 0.0078125f).endVertex();
            worldrenderer.pos(p_148171_1_ + 0, p_148171_2_ + 0, GuiFlatPresets.zLevel).tex((p_148171_3_ + 0) * 0.0078125f, (p_148171_4_ + 0) * 0.0078125f).endVertex();
            tessellator.draw();
        }
