...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    private void drawSprite(final int p_146527_1_, final int p_146527_2_, final int p_146527_3_, final int p_146527_4_) {
        ...
        worldrenderer.pos(p_146527_1_ + 0, p_146527_2_ + 18, GuiStats.zLevel).tex((p_146527_3_ + 0) * 0.0078125f, (p_146527_4_ + 18) * 0.0078125f).endVertex();
        worldrenderer.pos(p_146527_1_ + 18, p_146527_2_ + 18, GuiStats.zLevel).tex((p_146527_3_ + 18) * 0.0078125f, (p_146527_4_ + 18) * 0.0078125f).endVertex();
        worldrenderer.pos(p_146527_1_ + 18, p_146527_2_ + 0, GuiStats.zLevel).tex((p_146527_3_ + 18) * 0.0078125f, (p_146527_4_ + 0) * 0.0078125f).endVertex();
        worldrenderer.pos(p_146527_1_ + 0, p_146527_2_ + 0, GuiStats.zLevel).tex((p_146527_3_ + 0) * 0.0078125f, (p_146527_4_ + 0) * 0.0078125f).endVertex();
        tessellator.draw();
    }
