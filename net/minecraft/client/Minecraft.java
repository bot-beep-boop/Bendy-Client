...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        SplashProgress.setProgress(2, String.valueOf(Client.ClientName) + " - Loading Ingame Mods");
        this.modelManager = new ModelManager(this.textureMapBlocks);
        this.mcResourceManager.registerReloadListener(this.modelManager);
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
        SplashProgress.setProgress(3, String.valueOf(Client.ClientName) + " - Loading Cosmetics");
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        SplashProgress.setProgress(4, String.valueOf(Client.ClientName) + " - Loading File Manager");
        this.itemRenderer = new ItemRenderer(this);
        SplashProgress.setProgress(5, String.valueOf(Client.ClientName) + " - Loading Event Manager");
        this.mcResourceManager.registerReloadListener(this.renderItem);
        this.entityRenderer = new EntityRenderer(this, this.mcResourceManager);
        this.mcResourceManager.registerReloadListener(this.entityRenderer);
        SplashProgress.setProgress(6, String.valueOf(Client.ClientName) + " - Loading Perspective Mod");
        this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(), this.gameSettings);
        this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);
        this.renderGlobal = new RenderGlobal(this);
        SplashProgress.setProgress(4, String.valueOf(Client.ClientName) + " - Loading Main Menu");
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Client.ClientName);
        try {
    ...
    private void runGameLoop() throws IOException {
        ...
        while (getSystemTime() >= this.debugUpdateTime + 1000L) {
            Minecraft.debugFPS = this.fpsCounter * Client.FPSBoost;
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                final KeyEvent event2 = new KeyEvent(k);
                event2.call();
