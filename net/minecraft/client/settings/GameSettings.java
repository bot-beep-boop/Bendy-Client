...
public class GameSettings
{
    ...
    public KeyBinding CLIENT_GUI_MOD_SETTINGS;
    ...
    public GameSettings(final Minecraft mcIn, final File p_i46326_2_) {
        ...
        this.CLIENT_GUI_MOD_SETTINGS = new KeyBinding("Mod Settings", 54, Client.ClientName);
        this.ZOOM = new KeyBinding("Zoom", 46, Client.ClientName);
        this.CLIENT_PERSPECTIVE = new KeyBinding("Perspective Mod", 33, Client.ClientName);
    ...
    private void addClientKeybinds() {
        ...
        this.keyBindings = (KeyBinding[])ArrayUtils.add((Object[])this.keyBindings, (Object)this.CLIENT_GUI_MOD_SETTINGS);
    }
