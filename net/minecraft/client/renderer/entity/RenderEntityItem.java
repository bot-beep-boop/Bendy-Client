...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    public void doRender(final EntityItem entity, final double x, final double y, final double z, final float entityYaw, final float partialTicks) {
        ...
        if (this.bindEntityTexture(entity)) {
            RenderManager.renderEngine.getTexture(this.getEntityTexture(entity)).setBlurMipmap(false, false);
            flag = true;
        }
        ...
        if (flag) {
            RenderManager.renderEngine.getTexture(this.getEntityTexture(entity)).restoreLastBlurMipmap();
        }
