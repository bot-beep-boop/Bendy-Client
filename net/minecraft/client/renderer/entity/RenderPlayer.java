...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    public RenderPlayer(final RenderManager renderManager, final boolean useSmallArms) {
        ...
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticCape(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticCap(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticCape2(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticCape3(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticCape4(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticHalo(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticHat(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticGhostWings(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticWings(this));
        ((RendererLivingEntity<EntityLivingBase>)this).addLayer(new CosmeticWitchHat(this));
