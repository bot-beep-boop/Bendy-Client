...
public class RenderManager
{
    ...
    public RenderManager(final TextureManager renderEngineIn, final RenderItem itemRendererIn) {
        ...
        RenderManager.renderEngine = renderEngineIn;
        ...
        this.entityRenderMap.put(EntitySnowball.class, new RenderSnowball<Entity>(this, Items.snowball, itemRendererIn));
        this.entityRenderMap.put(EntityEnderPearl.class, new RenderSnowball<Entity>(this, Items.ender_pearl, itemRendererIn));
        this.entityRenderMap.put(EntityEnderEye.class, new RenderSnowball<Entity>(this, Items.ender_eye, itemRendererIn));
        this.entityRenderMap.put(EntityEgg.class, new RenderSnowball<Entity>(this, Items.egg, itemRendererIn));
        this.entityRenderMap.put(EntityPotion.class, new RenderPotion(this, itemRendererIn));
        this.entityRenderMap.put(EntityExpBottle.class, new RenderSnowball<Entity>(this, Items.experience_bottle, itemRendererIn));
        this.entityRenderMap.put(EntityFireworkRocket.class, new RenderSnowball<Entity>(this, Items.fireworks, itemRendererIn));
    ...
    public void cacheActiveRenderInfo(final World worldIn, final FontRenderer textRendererIn, final Entity livingPlayerIn, final Entity pointedEntityIn, final GameSettings optionsIn, final float partialTicks) {
        ...
        if (livingPlayerIn instanceof EntityLivingBase && ((EntityLivingBase)livingPlayerIn).isPlayerSleeping()) {
            ...
            if (block == Blocks.bed) {
                final int i = iblockstate.getValue((IProperty<EnumFacing>)BlockBed.FACING).getHorizontalIndex();
