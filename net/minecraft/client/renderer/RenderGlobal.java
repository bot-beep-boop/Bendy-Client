        ...
        if (p_72731_3_ == 0 && movingObjectPositionIn.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (block.getMaterial() != Material.air && this.theWorld.getWorldBorder().contains(blockpos)) {
                ...
                if (Client.BlockOverlay) {
                    Client.drawColoredBlockOverlay(block.getSelectedBoundingBox(this.theWorld, blockpos).expand(0.0020000000839462844, 0.0020000000839462844, 0.0020000000839462844).offset(-d0, -d2, -d3), 66, 179, 245, 45);
                }
                GlStateManager.depthMask(true);
                GlStateManager.enableTexture2D();
                GlStateManager.disableBlend();
